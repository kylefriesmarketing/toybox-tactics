...
export const UNITS = {
  ...
  archer: {
    ...
    // the wish-class counter (research rank 3, the bonus:{mega:10} pattern):
    // every strange toy that walks out of the dark is pre-answered by a unit
    // every faction always has. The size-up surfaces it automatically.
    bonus: { wish: 6 },
  ...
  ironhorse: {
    name: 'The Iron Horse', tags: ['siege', 'vehicle', 'mega'], age: 3, proc: 'raider', faction: 'wranglers', gait: 'roll',
    cost: { snacks: 220, blocks: 240 }, trainTime: 46,
    hp: 560, atk: 22, atkType: 'siege', interval: 2.0, range: 1.1, trample: 12,
    bonus: { building: 18 },
    armor: { melee: 6, pierce: 7 }, speed: 2.2, vision: 8, aggro: 6, radius: 0.55,
    impact: 0.5, color: 0x2b2f36,
    debris: { shapes: ['disc', 'peg', 'cube'], colors: [0x2b2f36, 0xc0392b, 0xd9a441], count: 12 },
    desc: 'MEGA (Wranglers): a wind-up locomotive with no brakes and no rails and no patience. It does not stop at your walls. It stops after them.',
  },
  thunderhoof: {
    name: 'Thunderhoof', tags: ['heavy', 'mega'], age: 3, proc: 'bear', faction: 'plains', gait: 'stomp',
    cost: { snacks: 320, blocks: 140 }, trainTime: 46,
    hp: 640, atk: 20, atkType: 'melee', interval: 1.8, range: 1.1, trample: 10,
    bonus: { ranged: 8, building: 10 },
    armor: { melee: 5, pierce: 6 }, speed: 1.9, vision: 8, aggro: 6, radius: 0.6,
    impact: 0.5, color: 0x6a4a32,
    debris: { shapes: ['limb', 'cube', 'stick'], colors: [0x6a4a32, 0xc0492b, 0x3aa6a0], count: 12 },
    desc: 'MEGA (Painted Plains): the great buffalo of the room, painted with the whole camp\'s story. When he runs, the floorboards keep the beat.',
  },
  paladin: {
  ...
  // ---- WISH TOYS (Slices 2+3) — donors re-tinted; NEVER in a trains array,
  // NEVER def.faction (eleven read sites). Appended at the END on purpose:
  // insertion order is the AI workshop picker\u2019s find() order. ----
  standardbearer: {
    name: 'The Standard Bearer',
    tags: ['infantry', 'heavy', 'wish'],
    age: 2,
    proc: 'lancer',
    hop: true,
    wish: true,
    ...
    impact: 0.45,
    color: 4881472,
    tint: { color: 4881472, amount: 0.85, rough: 0.5 },
    debris: { shapes: ['limb', 'limb', 'peg'], colors: [4881472, 4090678, 6065996], count: 7 },
    desc: 'The flag is the wish. Nearby workers gather 12% harder inside its circle — an army with a centre it does not want to leave.',
  },
  longgun: {
    name: 'The Long Gun',
    tags: ['siege', 'wish'],
    ...
    impact: 0.5,
    color: 5204794,
    tint: { color: 5204794, amount: 0.85, rough: 0.55, metalness: 0.15 },
    projectile: {
      speed: 8,
      arc: true,
      color: 10127978,
    ...
    debris: { shapes: ['stick', 'stick', 'disc'], colors: [5204794, 9071162], count: 9 },
    desc: 'One shot, one very big toy. Fires 55 siege at anything mega — and precisely nothing worth mentioning at everything else.',
  },
  cornerstone: {
    ...
    range: 0.85,
    bonus: { siege: 10 },
    armor: { melee: 5, pierce: 8 },
    speed: 0.85,
    vision: 5,
    aggro: 6,
    impact: 0.5,
    color: 16335172,
    debris: { shapes: ['brick', 'brick', 'cube'], colors: [16335172, 16369487, 5086207], count: 8 },
    wish: true,
    modelKey: 'knight',
    targetHeight: 0.66,
    tint: { color: 16335172, amount: 0.85, rough: 0.4 },
    desc: 'Wish-only: the brick the whole build rests on. Parks in a doorway, will not be moved, and cracks any siege engine that comes to knock.',
  },
  thecopy: {
    name: 'The Copy',
    tags: ['siege', 'vehicle', 'mega', 'wish'],
    age: 3,
    proc: 'soldier',
    gait: 'roll',
    cost: { blocks: 280, marbles: 180 },
    trainTime: 45,
    hp: 480,
    atk: 30,
    atkType: 'siege',
    ...
    debris: { shapes: ['brick', 'brick', 'cube'], colors: [16369487, 16335172, 5086207], count: 12 },
    wish: true,
    modelKey: 'tank',
    targetHeight: 0.86,
    tint: { color: 16369487, amount: 0.85, rough: 0.35 },
    desc: 'Wish-only MEGA: they watched the General\'s Tank get built and rebuilt it from memory, in brick. The copy shoots just as straight.',
  },
  nightlight: {
    name: 'The Night Light',
    tags: ['support', 'plush', 'wish'],
    age: 2,
    proc: 'medic',
    wish: true,
    modelKey: 'medic',
    targetHeight: 0.72,
    cost: { snacks: 70, buttons: 35 },
    trainTime: 14,
    hp: 60,
    atk: 1,
    atkType: 'melee',
    ...
    impact: 0.5,
    color: 16767354,
    tint: { color: 16767354, amount: 0.85, rough: 0.5, emissive: 16767354, emissiveIntensity: 2.6 },
    debris: { shapes: ['cube'], colors: [16767354, 15917752], count: 4, fluff: true },
    desc: 'A plush lamp nobody switched off. Mends nearby toys, and its glow reads from across the room.',
  },
  rockinghorse: {
    name: 'The Rocking Horse',
    tags: ['raider', 'heavy', 'wish'],
    age: 2,
    proc: 'raider',
    wish: true,
    modelKey: 'charger',
    targetHeight: 0.76,
    cost: { snacks: 120, blocks: 65 },
    trainTime: 16,
    hp: 110,
    atk: 10,
    atkType: 'melee',
    ...
    range: 0.9,
    bonus: { ranged: 6, worker: 3 },
    armor: { melee: 2, pierce: 2 },
    speed: 2.9,
    vision: 7,
    aggro: 6,
    impact: 0.5,
    color: 15914463,
    tint: { color: 15914463, amount: 0.85, rough: 0.62 },
    debris: { shapes: ['limb', 'stick'], colors: [15914463, 12159578], count: 8 },
    desc: 'Painted rose wood on stitched rockers, saddle sized for whoever needs carrying. It rocks toward the hurt.',
  },
  slotcar: {
    name: 'The Slot Car',
    tags: ['raider', 'vehicle', 'wish'],
    age: 2,
    proc: 'dragster',
    gait: 'roll',
    wish: true,
    modelKey: 'dragster',
    targetHeight: 0.58,
    tint: { color: 3064446, amount: 0.85, rough: 0.35 },
    cost: { snacks: 80, buttons: 80 },
    trainTime: 16,
    hp: 55,
    atk: 11,
    atkType: 'melee',
    ...
    impact: 0.4,
    color: 3064446,
    debris: { shapes: ['disc', 'disc', 'stick'], colors: [2236962, 3064446], count: 8 },
    desc: 'Wish toy (All the Way Wound): it only knows one groove and the groove goes through their workers.',
  },
  pacecar: {
    name: 'The Pace Car',
    tags: ['vehicle', 'wish'],
    ...
    modelKey: 'cart',
    proc: 'soldier',
    tint: { color: 16054010, amount: 0.85, rough: 0.35, metalness: 0.15 },
    heal: { rate: 6, range: 3 },
    cost: { snacks: 80, buttons: 60 },
    trainTime: 14,
    hp: 55,
    atk: 0,
    atkType: 'melee',
    ...
    impact: 0.5,
    color: 16054010,
    debris: { shapes: ['disc', 'disc', 'cube'], colors: [3355443, 16054010, 8947848], count: 6 },
    desc: 'Wish toy (Sponsorship): the pack never comes home — the pit crew goes with it, patching wheels at speed.',
  },
  hatchling: {
    name: 'The Hatchling',
    tags: ['heavy', 'wish'],
    ...
    modelKey: 'dragon',
    targetHeight: 0.45,
    tint: { color: 5223811, amount: 0.85, rough: 0.5 },
    cost: { snacks: 90, blocks: 70 },
    trainTime: 20,
    hp: 170,
    atk: 10,
    atkType: 'siege',
    ...
    impact: 0.5,
    color: 5223811,
    projectile: { speed: 10, arc: false, color: 12124058, size: 0.09, splash: 1, trail: 8052842 },
    debris: { shapes: ['limb', 'cube', 'stick'], colors: [5223811, 12124058, 14263361], count: 8 },
    desc: 'Wish toy (The Warm Egg): the roost was warm for a reason. Jade, knee-high, and completely certain it is a dragon. The little flame splashes.',
  },
  emptysuit: {
    name: 'The Empty Suit',
    tags: ['infantry', 'heavy', 'wish', 'mega'],
    age: 3,
    proc: 'titanbot',
    gait: 'stomp',
    wish: true,
    modelKey: 'titanbot',
    targetHeight: 1.16,
    tint: { color: 0xf2eee6, amount: 0.9, rough: 0.4, metalness: 0.15, emissive: 0x3a362e, emissiveIntensity: 0.5 },
    cost: { snacks: 150, marbles: 90 },
    trainTime: 26,
    hp: 400,
    atk: 20,
    atkType: 'melee',
    ...
    range: 0.95,
    bonus: { building: 12 },
    armor: { melee: 7, pierce: 9 },
    speed: 1.35,
    vision: 6,
    aggro: 6,
    impact: 0.5,
    color: 15922422,
    debris: { shapes: ['cube', 'disc', 'peg'], colors: [15922422, 13159638], count: 9 },
    desc: 'Wish toy (The Old Guard): a suit of armour with nobody home, standing its post anyway. It rises when asked, and lies back down once the night is held.',
  },
  unit4: {
    name: 'Unit 4',
    tags: ['infantry', 'bot', 'wish'],
    age: 2,
    proc: 'titanbot',
    gait: 'stomp',
    ...
    modelKey: 'forgotten',
    targetHeight: 0.46,
    tint: { color: 15247420, amount: 0.85, rough: 0.5, metalness: 0.3 },
    heal: { rate: 4, range: 3 },
    cost: { snacks: 60, buttons: 40 },
    trainTime: 16,
    pop: 1,
    hp: 120,
    atk: 6,
    ...
    impact: 0.5,
    color: 15247420,
    debris: { shapes: ['cube', 'disc'], colors: [15247420, 4870232], count: 6 },
    desc: 'Wish toy (Maintenance Report): the one who keeps the log. It follows the line and tightens what rattles — nearby toys mend at 4 hp a second.',
  },
  rewound: {
    name: 'Rewound',
    tags: ['infantry', 'heavy', 'wish', 'mega'],
    ...
    gait: 'stomp',
    wish: true,
    modelKey: 'forgottenking',
    targetHeight: 1.1,
    tint: { color: 11569726, amount: 0.85, rough: 0.4, metalness: 0.7 },
    regen: { rate: 8, idle: 4 },
    cost: { buttons: 240, marbles: 130 },
    trainTime: 45,
    pop: 5,
    slam: 2.4,
    hp: 520,
    ...
    interval: 2,
    range: 0.9,
    armor: { melee: 4, pierce: 5 },
    speed: 1.3,
    vision: 9,
    aggro: 7,
    impact: 1,
    color: 11569726,
    debris: { shapes: ['cube', 'disc', 'stick'], colors: [11569726, 4870232, 12626016], count: 14 },
    desc: 'Wish toy (Nobody Winds Us But Us): they found the biggest key in the drawer and took turns. Four quiet seconds and it winds itself — 8 hp every tick nobody is swinging.',
  },
  longhorn: {
    name: 'The Longhorn',
    tags: ['heavy', 'wish'],
    ...
    modelKey: 'bear',
    targetHeight: 0.66,
    tint: { color: 14272936, amount: 0.85, rough: 0.5 },
    cost: { snacks: 60, blocks: 35 },
    trainTime: 18,
    hp: 190,
    atk: 9,
    atkType: 'melee',
    ...
    impact: 0.5,
    color: 14272936,
    debris: { shapes: ['cube', 'limb'], colors: [14272936, 11030574], count: 8 },
    desc: 'Wish toy: a cream-hided steer with horns wider than a domino run. The herd walks where he walks.',
  },
  oldblue: {
    name: 'Old Blue',
    tags: ['raider', 'wish'],
    ...
    proc: 'bear',
    wish: true,
    modelKey: 'thunderhoof',
    targetHeight: 0.5,
    fetch: true,
    tint: { color: 6057866, amount: 0.85, rough: 0.55 },
    cost: { snacks: 160, blocks: 85 },
    trainTime: 20,
    hp: 150,
    atk: 7,
    atkType: 'melee',
    ...
    impact: 0.5,
    color: 6057866,
    debris: { shapes: ['limb', 'cube', 'stick'], colors: [6057866, 9082797], count: 8 },
    desc: 'Wish toy: a blue-grey cattle dog cast mid-trot. Finds every Lost Toy in the room and brings it home, tail going the whole way.',
  },
  paintedpony: {
    ...
    impact: 0.5,
    color: 3843744,
    tint: { color: 3843744, amount: 0.85, rough: 0.5 },
    debris: { shapes: ['limb', 'stick'], colors: [3843744, 10115632], count: 8 },
    desc: 'Wish toy: a pony painted in colours no set ever shipped. It was walking with the camp long before anyone thought to look down.',
  },
  oldstone: {
    name: 'The Old Stone',
    tags: ['infantry', 'heavy', 'wish', 'mega'],
    ...
    slam: 2.4,
    bonus: { building: 16 },
    armor: { melee: 6, pierce: 7 },
    speed: 1,
    vision: 5,
    aggro: 5,
    impact: 0.5,
    color: 9274743,
    tint: { color: 0x8a8478, amount: 0.95, rough: 0.95, stripMap: true },
    debris: { shapes: ['brick', 'brick', 'cube'], colors: [9274743, 7301726, 11905943], count: 12 },
    desc: 'Wish MEGA: the oldest toy on the plains, if it is a toy at all. It does not chase. It arrives, and the ground gives up.',
  },
};
...
export const MODEL_MANIFEST = {
  ...
  ironhorse:   { dir: 'assets/units/ironhorse',   model: 'model.glb', targetHeight: 0.72 },
  thunderhoof: { dir: 'assets/units/thunderhoof', model: 'model.glb', targetHeight: 0.78 },
...
export const BUILDINGS = {
  ...
  logfort: {
    ...
    trains: ['gunslinger', 'rider', 'ironhorse'], techs: ['roundup'],
  ...
  bigteepee: {
    ...
    trains: ['brave', 'bowhunter', 'thunderhoof'], techs: ['windrunner'],
...
export const MISSION_EVENTS = {
  naptime: [
    { at: 150, speaker: 'narrator', text: 'Under the bed, something soft shifted its weight. The Horde knows you are here now.' },
    { at: 155, speaker: 'plush', text: 'We hear you out there, little boots. Come in where it\'s warm. We\'ll tuck you in OURSELVES.' },
    { at: 300, type: 'spawn', unit: 'soldier', n: 3, owner: 0, kind: 'info', speaker: 'classic',
      text: 'Three of mine slept through the muster. They will drill until the shame wears off — AFTER we win.' },
  ],
  sandbox: [
    { at: 180, speaker: 'narrator', text: 'Sand gets into everything, the storybooks warn. Especially plans.' },
    { at: 360, type: 'boost', owner: 1, res: { snacks: 150, blocks: 150 }, kind: 'attack', speaker: 'bricks',
      text: 'A buried juice-box cache! Klik logs it as "found materials" and grins like a stud-plate. Our coffers overflow, and so shall our walls.' },
    { at: 540, type: 'spawn', unit: 'raider', n: 2, owner: 0, kind: 'info', speaker: 'classic',
      text: 'Two wind-up raiders roll in from the swing set. They salute. Roughly. In passing. At speed.' },
  ],
  bathtub: [
    { at: 200, speaker: 'narrator', text: 'The water remembers every armada. It is beginning to remember yours.' },
    { at: 380, type: 'spawn', unit: 'duckboat', n: 2, owner: 0, kind: 'info', speaker: 'classic',
      text: 'The rubber fleet answers! Two Duck Raiders squeak into formation. That squeak, Commander, is the sound of naval supremacy.' },
  ],
  hill: [
    { at: 180, speaker: 'narrator', text: 'Hold a hill long enough, the old toys say, and the hill starts holding you back.' },
    { at: 420, type: 'spawn', unit: 'lancer', n: 3, owner: 1, kind: 'attack', speaker: 'bricks',
      text: 'You are standing — click — on MY hill. The Lancers are coming to renegotiate the property line. Boing.' },
    { at: 640, type: 'spawn', unit: 'bear', n: 1, owner: 0, kind: 'info', speaker: 'plush',
      text: 'I sent you my biggest hug, dear. He\'s slow on the slope but he simply does not fall over.' },
  ],
  finale: [
    { at: 150, speaker: 'narrator', text: 'The attic holds its breath. Every retired toy is watching this one.' },
    { at: 400, type: 'boost', owner: 1, res: { snacks: 250, blocks: 250 }, kind: 'attack', speaker: 'bots',
      text: 'THE FIRST SOLDIER HAS CALLED IN THE ATTIC\'S DEBTS. CALCULATING ODDS. RECALCULATING. THE ODDS ARE RUDE.' },
    { at: 700, type: 'spawn', unit: 'hero', n: 1, owner: 0, kind: 'info', focus: true, speaker: 'narrator',
      text: 'Out of a dusty shoebox steps a hero the storybooks thought was lost. Not tonight.' },
  ],
  crumbs: [
    { at: 160, speaker: 'bots', text: 'GOOD MORNING. WE ARE HARVESTING YOUR TABLE IN PERFECT ROWS. YOU ARE WELCOME TO WATCH. BRIEFLY.' },
    { at: 380, type: 'spawn', unit: 'zapbot', n: 3, owner: 1, kind: 'attack', speaker: 'bots',
      text: 'A FRESH COLUMN DEPLOYS FROM THE BACKPACK. THEY HAVE BEEN INSTRUCTED TO CRACKLE POLITELY.' },
  ],
  sofa: [
    { at: 200, speaker: 'narrator', text: 'Cushion country: every ridge is soft, every ambush softer.' },
    { at: 450, type: 'spawn', unit: 'medic', n: 2, owner: 0, kind: 'info', speaker: 'plush',
      text: 'Two of my Medics, dear, with fresh thread and NO patience for heroics. Do try to need them less.' },
  ],
  canyonrun: [
    { at: 150, speaker: 'racers', text: 'Listen up! In the canyon the racing line IS the battle line. Hug the apex, win the war. GO GO GO!' },
    { at: 350, type: 'spawn', unit: 'drone', n: 2, owner: 0, kind: 'info', speaker: 'racers',
      text: 'Air support, hotshot! Two Whirly Drones off the shelf — try to keep up with your own reinforcements!' },
    { at: 600, type: 'boost', owner: 1, res: { buttons: 200 }, kind: 'attack', speaker: 'bots',
      text: 'WE HAVE REQUISITIONED A COIN JAR. OUR WAR CHEST IS NOW LITERALLY A CHEST OF COINS. EFFICIENCY.' },
  ],
  nightlight: [
    { at: 180, speaker: 'narrator', text: 'The nightlight flickers. Everything under the bed leans a little closer.' },
    { at: 420, type: 'spawn', unit: 'soldier', n: 4, owner: 1, kind: 'attack', speaker: 'classic',
      text: 'Old guard, Commander — men I trained before the Kid could whistle. The dark kept them. Now the dark spends them.' },
  ],
  shelfking: [
    { at: 200, speaker: 'bricks', text: 'You hear that click? That is my crown counting its own studs on the dictionary. It counts YOUR days too.' },
    { at: 450, type: 'spawn', unit: 'golem', n: 2, owner: 1, kind: 'attack', speaker: 'bricks', focus: true,
      text: 'The royal guard descends the poetry section! Two Golems, four hundred studs, zero mercy. Click. DONE.' },
    { at: 700, type: 'spawn', unit: 'titanbot', n: 1, owner: 0, kind: 'info', speaker: 'bots',
      text: 'FIELD-BUILT TITAN COMPLETE. IT SALUTES WITH THE WRONG ARM. WE ARE... PROUD OF IT ANYWAY.' },
  ],
  tagged: [
    { at: 150, speaker: 'narrator', text: 'Another car pulls in. The stickers glitter like little round dooms.' },
    { at: 400, type: 'spawn', unit: 'raider', n: 3, owner: 1, kind: 'attack', speaker: 'racers',
      text: 'Yard crew inbound off the sprinkler line! Sun-bleached, half-feral, and they do NOT brake for strangers!' },
  ],
  boxed: [
    { at: 180, speaker: 'narrator', text: 'Somewhere above, tape screeches. Another box is being sealed.' },
    { at: 400, type: 'spawn', unit: 'sockpuppet', n: 3, owner: 0, kind: 'info', speaker: 'plush',
      text: 'Three Sock Puppets found a gap in the flaps, dear. The dark is officially less dark. Socks always find a way.' },
  ],
  bargain: [
    { at: 160, speaker: 'narrator', text: 'A shopper\'s shadow crosses the bin. Everyone holds very, very still.' },
    { at: 380, type: 'boost', owner: 1, res: { snacks: 200, blocks: 100 }, kind: 'attack', speaker: 'bots',
      text: 'THE STRANGERS HAVE RESTOCKED VIA BARTER. WE MONITORED THE TRANSACTION. THE EXCHANGE RATE WAS INSULTING.' },
    { at: 620, type: 'spawn', unit: 'golem', n: 1, owner: 0, kind: 'info', speaker: 'bricks',
      text: 'Psst. Bottom of the bin. Loose bricks. My masons built you a friend. Do not ask where the instructions came from.' },
  ],
  stranger: [
    { at: 180, speaker: 'narrator', text: 'The Prize Robot polishes itself. It has never once needed polishing.' },
    { at: 420, type: 'spawn', unit: 'zapbot', n: 4, owner: 1, kind: 'attack', speaker: 'bots',
      text: 'MINT-IN-BOX ESCORTS DEPLOYING IN FACTORY FORMATION. NOTE THEIR FINISH. NOTE IT.' },
    { at: 650, type: 'spawn', unit: 'dragster', n: 2, owner: 0, kind: 'info', speaker: 'racers', focus: true,
      text: 'Hear those engines?! Two of ours came BACK — roaring down the sidewalk to fight for the wagon they escaped. That\'s family, hotshot.' },
  ],
  wayhome: [
    { at: 200, speaker: 'narrator', text: 'The porch light holds steady across the dark lawn — a lighthouse that knows your name.' },
    { at: 450, type: 'spawn', unit: 'bear', n: 1, owner: 0, kind: 'info', speaker: 'plush',
      text: 'A bear the sale forgot, dear — shaking the grass from his fur and falling in beside you. Nobody gets left twice.' },
    { at: 750, speaker: 'classic', text: 'Almost home. The window is open. The old bear is waiting. MARCH, Commander — best speed, heads high.' },
  ],
  midnight: [
    { at: 90, speaker: 'narrator', text: 'Tick. Tick. The attic counts along with the war, and it has been counting far longer than you.' },
    { at: 240, type: 'spawn', unit: 'golem', n: 1, owner: 0, kind: 'info', speaker: 'bricks',
      text: 'One flag tonight, Commander. A Golem, assembled from the trilogy\'s spare pieces. Every stud I ever molded is in your column now.' },
    { at: 400, type: 'spawn', unit: 'bear', n: 1, owner: 0, kind: 'info', speaker: 'plush',
      text: 'My best hug is climbing the ladder, dear. It has never once missed. Not once, in all the bedtimes there have ever been.' },
    { at: 500, type: 'spawn', unit: 'forgotten', n: 3, owner: 1, kind: 'attack', speaker: 'narrator',
      text: 'Three Forgotten Ones step out of the shadow between boxes, keys turning all by themselves.' },
    { at: 560, type: 'spawn', unit: 'dragster', n: 1, owner: 0, kind: 'info', speaker: 'racers',
      text: 'Donating the tribe\'s fastest bad idea to the cause, hotshot. Point it at the dark and let GO.' },
    { at: 700, type: 'spawn', unit: 'zapbot', n: 2, owner: 0, kind: 'info', speaker: 'bots',
      text: 'TWO OF OURS CLIMB TO FACE THE FORGOTTEN. THEY ARE OUR OLDEST FEAR. OUR EYES ARE GLOWING STEADY. THIS IS NOT A MALFUNCTION.' },
    { at: 800, type: 'spawn', unit: 'forgotten', n: 4, owner: 1, kind: 'attack', speaker: 'narrator',
      text: 'More of them. The attic has been saving toys the way winter saves snow.' },
    { at: 850, type: 'boost', owner: 1, res: { snacks: 300, blocks: 300, buttons: 200 }, kind: 'attack', speaker: 'narrator',
      text: 'The First Forgotten opens a box that was never unpacked. A hundred years of birthday presents answer to him now.' },
    { at: 1000, type: 'spawn', unit: 'hero', n: 1, owner: 0, kind: 'info', focus: true, speaker: 'classic',
      text: 'A hero climbs the ladder LAST, Commander — the way heroes always do. So that no one is behind them.' },
    { at: 1100, type: 'spawn', unit: 'forgottenking', n: 1, owner: 1, kind: 'attack', focus: true, speaker: 'narrator',
  ...
  alliance: [
    { at: 60, speaker: 'knights', text: 'Your army men keep saluting my knights, Commander, and my knights keep saluting back. I have issued no order to stop. I shall not.' },
    { at: 180, speaker: 'classic', text: 'Hector, your people bow to my privates. My privates now expect it. This alliance is ruining discipline and I could not be prouder.' },
    { at: 300, type: 'spawn', unit: 'knight', n: 2, owner: 1, kind: 'info', speaker: 'knights',
      text: 'Two of my own to stand your wall — borrowed vows, General. Return them dented if you must. Return them PROUD.' },
    { at: 600, speaker: 'bots', text: 'OBSERVATION: KLIK BUILDS. WE COUNT. AN ALLIANCE OF LEDGERS VERSUS AN ALLIANCE OF PROMISES. THE LEDGERS DO NOT BLINK.' },
    { at: 900, type: 'boost', owner: 2, res: { blocks: 200, buttons: 150 }, kind: 'attack', speaker: 'bricks',
      text: 'Cogsworth and I have pooled our pockets. One assembly line. Two armies. Zero sentiment. Click. Done.' },
    { at: 1200, speaker: 'narrator', text: 'A knight falls covering an army man he met tonight. The room writes the word "allies" in its book and underlines it twice.' },
  ],
  doorstep: [
    { at: 60, speaker: 'narrator', text: 'The door closes behind the expedition. For the first time in any story the room ever told, the ceiling is weather.' },
    { at: 180, speaker: 'classic', text: 'Eyes forward, Commander. That blue up there is not the ceiling. Do NOT tell the recruits. Morale is complicated enough.' },
    { at: 300, speaker: 'narrator', text: 'A breeze crosses the column and every flag learns what flags are FOR. Even the veterans stop marching for a second.' },
    { at: 700, type: 'spawn', unit: 'scout', n: 2, owner: 0, kind: 'info', speaker: 'racers',
      text: 'Two wild scouts just defected to you, hotshot — sun-bleached, barefoot, grinning like hubcaps. They know the sandbox road!' },
  ],
  dunes: [
    { at: 90, speaker: 'bricks', text: 'The sand gets into EVERYTHING. My engineers have filed seventeen complaints and, confusingly, one love letter.' },
    { at: 420, speaker: 'bricks', text: 'A dune MOVED in the night, Commander. Nobody saw it happen. The scouts have started naming them. I have approved this. It feels safer.' },
    { at: 800, type: 'boost', owner: 1, res: { buttons: 150, marbles: 80 }, kind: 'attack', speaker: 'bots',
      text: 'OUR EXCAVATOR HAS STRUCK A VEIN OF LOST MARBLES. FUNDING. FOR THE ARCHIVE. DO NOT ASK WHAT THE ARCHIVE IS.' },
  ],
  gardenwar: [
    { at: 75, speaker: 'knights', text: 'The sunflowers turn to watch us pass, Commander. I am saluting every single one. I am aware it is taking a while. Chivalry is not efficient.' },
    { at: 240, speaker: 'racers', text: 'Hey tin-can! While you\'re saluting the FLOWERS we\'re lapping your siege line! This garden\'s OURS, buttercup!' },
    { at: 360, speaker: 'knights', text: 'The gnome has watched four hundred summers of this garden. I have knighted him in my heart already. He remains, as ever, unconsulted.' },
    { at: 780, type: 'spawn', unit: 'knight', n: 2, owner: 0, kind: 'info', speaker: 'knights',
      text: 'Two of mine arrive late and breathless, bearing a tomato like a war trophy. Reinforcements, Commander — and lunch.' },
  ],
  washout: [
    { at: 60, speaker: 'narrator', text: 'Somewhere under the yard, a pipe clears its throat. Every toy on the field pretends not to have heard it.' },
  ...
  oakcrown: [
    ...
    { at: 300, speaker: 'plush', text: 'Look at him wave, dear. Two nights alone in the wild and not one seam of him doubted us. THAT is what we\'re made of.' },
    { at: 420, type: 'spawn', unit: 'monster', n: 1, owner: 1, kind: 'attack', focus: true, speaker: 'narrator',
    ...
    { at: 800, speaker: 'classic', text: 'The porch light just came on across the yard. Nearly bedtime, Commander. Nearly home. Take the hill — and let\'s go get our rabbit.' },
  ],
  zero: [
    { at: 45, speaker: 'narrator', text: 'The rug is smaller than you remember. Everything was, back then — except the feelings.' },
    { at: 240, speaker: 'narrator', text: 'Across the mat, the bear drills his stuffing into ranks. He is not angry. That is what makes him terrifying.' },
    { at: 540, speaker: 'narrator', text: 'No medics yet. No walls yet. Nobody has invented mercy rules for toy wars — that comes after tonight, because of tonight.' },
    { at: 900, speaker: 'narrator', text: 'The lamp holds its light very still, the way you hold your breath at the part of the story where the friends fight.' },
  ],
};
...
export const WISHES = {
  ...
  oldguard: {
    ...
    devout: { charges: 1 },
    power: { k: 'suits', charges: 1, label: 'One More Night', n: 3, life: 45, leash: 12, unit: 'emptysuit',
      desc: 'Three Empty Suits stand up at a keep you own, hold for 45 seconds, then lie down again.' },
  },
  ...
  nobodywinds: {
    ...
    unit: { key: 'rewound', at: ['chest', 'robolab'] },
    devout: { charges: 1 },
  ...
  junkdrawer: {
    ...
    gift: { res: { snacks: 150, blocks: 150, buttons: 100, marbles: 50 },
      free: { basket: 1 } },
    devout: { free: { basket: 1 } },
    power: { k: 'deposit', charges: 1, label: 'Turn It Out',
      desc: 'Every worker banks what it is carrying, right now.' },
  },

  // ---- SLICES 2+3: the six remaining tribes + the room (fleet-authored, law-checked) ----
  quartermaster: {
    name: 'Quartermaster\'s List',
    icon: '📋',
    lane: 'hearth',
    tier: 1,
    blurb: 'Everything on the list, counted twice, stacked where the work is.',
    gift: { res: { snacks: 150 }, free: { basket: 2 } },
  ...
  digin: {
    ...
    lane: 'keep',
    tier: 1,
    blurb: 'A soldier\'s shovel is the other half of his rifle.',
    ...
    power: {
      ...
      t: 12,
      fx: { drHold: 0.4 },
      desc: 'For 12 seconds, your toys HOLDING STILL in the circle take 40% less damage. Runners get nothing.',
    },
  },
  secondwave: {
    name: 'Second Wave',
    ...
    lane: 'march',
    tier: 2,
    blurb: 'The first wave taught the second everything it knows.',
    gift: { techs: ['whetstone'], nextStar: { n: 8 } },
    power: {
      k: 'spawn',
      charges: 1,
      label: 'The Second Wave',
      unit: 'soldier',
      n: 4,
      desc: 'Four Block Soldiers report at a building you own, over the pop cap.',
    },
    devout: { charges: 1 },
  },
  longwatch: {
    ...
    lane: 'keep',
    tier: 2,
    blurb: 'Someone has to stay up. Someone always has.',
    gift: { res: { blocks: 120 }, free: { tower: 2 } },
    unit: { key: 'longgun', at: ['chest', 'workshop'] },
    power: {
      k: 'place',
      charges: 1,
      label: 'One More Post',
      building: 'tower',
      desc: 'Raise a finished Watch Tower anywhere you can see. It stays.',
    },
    devout: { charges: 1 },
  },
  flag: {
    name: 'Teach Them a Flag',
    icon: '🚩',
    lane: 'march',
    tier: 1,
    room: true,
    blurb: 'They belonged to nobody. Then somebody taught them a flag.',
  ...
  sortbycolour: {
    ...
    lane: 'hearth',
    tier: 1,
    blurb: 'Reds with reds, blues with blues. The bin always knew where everything went.',
  ...
  picture: {
    name: 'What the Picture Showed',
    icon: '🖼️',
    lane: 'march',
    tier: 1,
    blurb: 'The picture on the box was a promise. Start building toward it.',
    ...
    power: {
      ...
      building: 'wall',
      n: 1,
      desc: 'Place one finished Block Wall anywhere you have vision.',
    },
  },
  onebrick: {
    name: 'One Brick Taller',
    icon: '🧱',
    lane: 'keep',
    tier: 1,
    blurb: 'Every wall in the room is exactly one brick from being taller.',
    gift: { mods: { wallHp: 1.8 }, retroWallHp: 1.8, free: { wall: 10 } },
  ...
  spareparts: {
    name: 'Everything Is Spare Parts',
    icon: '⚙️',
    lane: 'hearth',
    tier: 2,
    blurb: 'Nothing in this room is broken. It is just waiting to be something else.',
    gift: { wreckRefund: { frac: 0.6 }, res: { blocks: 250 }, free: { basket: 2 } },
    power: {
      k: 'wreckwindow',
      charges: 1,
      label: 'Spare Parts',
      t: 60,
      frac: 0.6,
      desc: 'For 60 seconds, every building of yours that falls refunds 60% of its cost.',
    },
    devout: { free: { house: 1 } },
  },
  wewatched: {
    name: 'We Watched Them Build It',
    icon: '👀',
    lane: 'march',
    tier: 2,
    blurb: 'They watched it go up, stud by stud. They can do it again from memory.',
    gift: { techs: ['steelwork'] },
  ...
  clickdone: {
    ...
    lane: 'keep',
    tier: 2,
    blurb: 'No instructions. No waiting. Click. Done.',
  ...
  leaveiton: {
    ...
    lane: 'hearth',
    tier: 1,
    blurb: 'Somebody left the night light on. The dark keeps its manners around a loved toy.',
    gift: { res: { snacks: 120 }, free: { house: 3 } },
    ...
    power: {
      ...
      fx: { heal: 5 },
      leash: 6,
      desc: 'A pool of lamplight on your own ground: friendly toys inside heal 5 hp a second for 15 seconds.',
    },
  },
  hugline: {
    name: 'Hold the Line, Hug the Prisoners',
    icon: '🤗',
    lane: 'keep',
    tier: 1,
    blurb: 'Nobody gets left on the floor. Not even theirs.',
    ...
    power: {
      ...
      fx: { bounty: 20 },
      leash: 5,
      desc: 'A circle on your own ground, for 20 seconds: every enemy toy that falls inside it pays you 20 snacks.',
    },
  },
  warmheap: {
    name: 'The Warm Heap',
    ...
    lane: 'hearth',
    tier: 2,
    blurb: 'The pile at the foot of the bed is not where toys end up. It is where they get back up.',
    gift: { revive: { n: 6, hpFrac: 0.6 }, res: { snacks: 200 } },
    power: {
      k: 'warmheal',
      charges: 1,
      label: 'Tucked In',
      amount: 40,
      desc: 'Every friendly toy on the map heals 40 hp, right now.',
    },
    devout: { free: { house: 1 } },
  },
  rideorrescue: {
    ...
    lane: 'march',
    tier: 2,
    blurb: 'The horse rocks whether or not anyone is riding. Tonight, somebody is.',
    gift: { techs: ['grouphug'] },
    unit: { key: 'rockinghorse', at: ['chest'] },
    power: {
      k: 'unitboost',
      charges: 1,
      label: 'Ride Out',
      ...
      type: 'medic',
      speed: 0.8,
      desc: 'For 25 seconds your Plush Medics move 80% faster and heal without stopping.',
    },
    devout: { charges: 1 },
  },
  allwound: {
    name: 'All the Way Wound',
    icon: '🔑',
    lane: 'march',
    tier: 1,
    blurb: 'Somebody turned the key until it clicked. Then twice more.',
    gift: { res: { snacks: 220 } },
    ...
    power: {
      ...
      r: 6,
      t: 10,
      fx: { speed: 0.6, wheeled: true },
      desc: 'For 10 seconds, wheeled toys in the zone floor it: +60% speed.',
    },
  },
  marshals: {
    name: 'Marshals on the Track',
    icon: '🚩',
    lane: 'keep',
    tier: 1,
    blurb: 'Every crash gets a flag. Every flag has somebody holding it.',
    ...
    power: {
      ...
      fx: { slowEnemy: 0.4 },
      leash: 6,
      desc: 'Enemy toys near a building you own are slowed 40% for 8 seconds.',
    },
  },
  sponsorship: {
    name: 'Sponsorship',
    ...
    lane: 'hearth',
    tier: 2,
    blurb: 'A very big toy company believes in you now. Their sticker is on everything.',
    gift: { res: { buttons: 500 } },
    unit: { key: 'pacecar', at: ['chest'] },
    power: {
      k: 'trainboost',
      charges: 1,
      label: 'Factory Backing',
      t: 25,
      desc: 'One building of yours trains at triple speed for 25 seconds.',
    },
    devout: { free: { house: 1 } },
  },
  folded: {
    name: 'Folded From the Instructions',
    icon: '📄',
    lane: 'march',
    tier: 2,
    blurb: 'Step 12 was underlined. Nobody underlines step 12 for no reason.',
    gift: { techs: ['springs'], res: { buttons: 120 } },
    power: {
      k: 'unitboost',
      charges: 1,
      label: 'Full Send',
      ...
      speed: 1,
      dmgTaken: 0.25,
      desc: 'For 12 seconds your wheeled toys double their speed — and take 25% more damage.',
    },
    devout: { charges: 1 },
  },
  wholeherd: {
    ...
    lane: 'march',
    tier: 1,
    blurb: 'A herd is not a number. Bring every last one of them.',
    gift: { res: { snacks: 100 }, free: { house: 3 } },
    ...
    power: {
      ...
      t: 6,
      fx: { speed: 0.5 },
      desc: 'Plant the marker: for 6 seconds your toys within 8 tiles move 50% faster. A rally, not a teleport — point them somewhere and RIDE.',
    },
  },
  mendfence: {
    name: 'Mend the Fence',
    ...
    lane: 'keep',
    tier: 1,
    blurb: 'A good fence gets mended before anybody notices it was down.',
  ...
  bringhome: {
    name: 'Bring \'Em All Home',
    icon: '🏠',
    lane: 'hearth',
    tier: 2,
    blurb: 'Supper is on. Nobody eats until everybody is home.',
    gift: { res: { snacks: 400 }, free: { farm: 2 } },
    unit: { key: 'oldblue', at: ['chest'] },
    power: {
      k: 'deposit',
      charges: 1,
      label: 'Suppertime',
      desc: 'Every worker banks what it is carrying, right now, then heads straight back to work.',
    },
    devout: { free: { house: 1 } },
  },
  donttouch: {
    name: 'Don\'t Touch the Herd',
    icon: '🐂',
    lane: 'keep',
    tier: 2,
    blurb: 'You can look. You can point. You can even holler. That is all.',
    gift: { mods: { armorOther: 1 }, free: { logfort: 1 }, res: { snacks: 100 } },
    power: {
      k: 'zone',
      charges: 1,
      ...
      leash: 12,
      fx: { dr: 0.3, heal: 4 },
      desc: 'For 18 seconds your toys within 6 tiles take 30% less damage and mend 4 hp a second. Must be drawn within 12 tiles of a building you own.',
    },
    devout: { charges: 1 },
  },
  movecamp: {
    ...
    lane: 'hearth',
    tier: 1,
    blurb: 'The camp is not the ground it stands on. The camp is whoever is standing there.',
  ...
  whatwalks: {
    name: 'What Walks With Us',
    icon: '🐾',
    lane: 'march',
    tier: 1,
    blurb: 'Some tracks in the paint were never yours. Something has been keeping pace all along.',
    gift: { res: { snacks: 80 }, free: { house: 4 } },
    ...
    power: {
      ...
      r: 6,
      t: 14,
      fx: { speed: 0.35, rangedDr: 0.2 },
      desc: 'For 14 seconds your toys in the circle move 35% faster, and arrows mean a fifth less.',
    },
  },
  season: {
    ...
    lane: 'hearth',
    tier: 2,
    blurb: 'The mats know before the room does. Plant where the season is going, not where it was.',
    gift: { mods: { farmRate: 1.25 }, free: { farm: 4 }, res: { snacks: 200 } },
    power: {
      k: 'farmseason',
      charges: 1,
      label: 'The Good Season',
      t: 30,
      desc: 'For 30 seconds every Snack Mat you own yields double.',
    },
    devout: { free: { house: 1 } },
  },
  keeping: {
    name: 'Keeping Everything That Does',
    icon: '🗿',
    lane: 'keep',
    tier: 2,
    blurb: 'The plains keep nothing that does not matter — and everything that does, they keep in stone.',
    gift: { techs: ['reinforced'], free: { bigteepee: 1 } },
    ...
    power: {
      ...
      r: 3,
      dmg: 60,
      desc: 'A stone lands where you aim. Whatever stood there feels it — and the ground remembers, slowing every enemy that crosses it, for good.',
    },
    devout: { charges: 1 },
  },
  couch: {
    name: 'Nobody Under the Couch',
    icon: '🛋️',
    lane: 'hearth',
    tier: 1,
    room: true,
    blurb: 'Nothing was ever lost. It was only under the couch.',
  ...
  floorboard: {
    ...
    tier: 2,
    room: true,
    blurb: 'Every room has one board that tells on you. Now you know which one.',
    ...
    power: {
      ...
      leash: 12,
      creak: 8,
      desc: 'A creaking stretch of floor near your buildings — enemies inside slow to a tiptoe, forever. Cast again to CREAK it.',
    },
    devout: { charges: 1 },
  },
  lightonw2: {
    name: 'Left the Light On',
    icon: '💡',
    lane: 'keep',
    tier: 2,
    room: true,
    blurb: 'Somebody left the hall light on. The dark gave a little ground.',
    gift: { res: { blocks: 180 }, free: { tower: 2 } },
    power: {
      k: 'light',
      charges: 1,
      label: 'The Hall Light',
      r: 14,
      t: 30,
